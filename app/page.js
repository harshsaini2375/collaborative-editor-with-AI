...
export default function Home() {
  ...
  return (
    ...
    ${openAIpanel ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5 pointer-events-none'}`} >
      ...
      <div className="left hidden md:block h-full w-[25%]  ">
        <Chatbot documentId={"doc-2"} />
      </div>

      <div className='mainhome md:mt-0 mt-3 md:py-0 py-5 w-full md:w-[75%] px-2 md:px-[5vw] bg-white rounded-2xl h-[89vh]
        ...
        <div className='intro w-full h-fit md:h-[35vh] flex flex-col items-center justify-center'>
          ...
          <div className='AddAndJoin w-full md:w-[38vw] flex-col md:flex-row flex gap-2 justify-between  items-center mt-5 md:mt-0 mb-10 md:mb-0'>
            ...
            <div className='joinDocument w-full md:w-[25vw]'>
        ...
        <div className='recently visited px-0 md:px-5 h-fit w-full'>
          ...
          <div className='yourDocuments my-5 w-full h-[19vh] flex gap-2 md:gap-5 overflow-auto no-scrollbar'>
