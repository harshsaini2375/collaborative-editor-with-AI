...
const Searchbar = ({ usedFor }) => {
    ...
    return (
        <div className='relative '>
            <div className='border-2 border-blue-500 bg-white h-[5vh] w-[30vw] rounded-lg flex gap-2 items-center px-3  '>
            ...
            {searchfocus && <div className='resultsOfSearch absolute top-6  overflow-auto no-scrollbar bg-white showresults h-[55vh] w-[30vw] border-2 border-gray-200 z-50 rounded-lg mt-5 p-5
             shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)]
        hover:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-2px_rgba(0,0,0,0.05)]
        transition-shadow duration-300  '>

                {results.length == 0 ? <div className='ifNoDocFound flex flex-col mt-20 items-center h-full w-full gap-1'>
                    ...
                    <Link key={element._id} href={`/${usedFor}/${usedFor == 'collabeditor' ? element._id : element.id}`}> <div className='flex gap-2 mb-2 bg-[#f7f7f7] rounded-lg px-4 py-2 items-center '>
