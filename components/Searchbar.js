...
const Searchbar = ({ usedFor }) => {
    ...
    return (
        <div className='relative '>
            ...
            {searchfocus && <div className='resultsOfSearch absolute top-3 md:top-6  overflow-auto no-scrollbar bg-white showresults h-[35vh] md:h-[55vh] w-[95vw] md:w-[30vw] border-2 border-gray-200 z-50 rounded-lg mt-5 p-2 md:p-5
        ...
        transition-shadow duration-300  '>
                ...
                {results.length == 0 ? <div className='ifNoDocFound flex flex-col mt-5 md:mt-20 items-center h-full w-full gap-1'>
                    ...
                    <Link key={element._id} href={`/${usedFor}/${usedFor == 'collabeditor' ? element._id : element.id}`}> <div className='flex gap-2 mb-2 bg-gray-300 md:bg-[#f7f7f7] rounded-[4px] md:rounded-lg px-2 md:px-4 text-sm md:text-base py-1 md:py-2 items-center '>
