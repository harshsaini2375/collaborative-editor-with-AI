...
const Templatecard = ({ templateObject, templateID }) => {
  return (
    <Link href={`/templates/${templateID}`} >
      <div className='border-2 border-gray-200 hover:bg-gray-100 rounded-xl overflow-hidden h-[30vh] w-[21vw] '>
        <div className='demoImage bg-white relative w-full h-[22vh] border-b-2 border-b-gray-200 '>
